...
export default class ChessboardArrows {
    ...
    private resFactor: number = 2;
    private colour: string = 'rgb(21, 120, 27)';
    ...
    ChessboardArrows(id : string, groupId: string, userRole: string, globalMode:boolean, resFactor: number, colour: string) {
    ...
    public socketDrawArrowToCanvas(fromx: any, fromy: any, tox: any, toy: any, color: any, resolution: number): void {
    ...
    public drawCircleSocket(x: any, y: any, color: string, resolution: number): void {
        this.primaryContext.strokeStyle = this.primaryContext.fillStyle = color;
